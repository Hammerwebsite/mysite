...
package cdi_new_prod.generate_error_0_1;
...
/**
 * Job: generate_error Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class generate_error implements TalendJob {
	...
	private final String jobName = "generate_error";
	private final String projectName = "CDI_NEW_PROD";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					generate_error.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(generate_error.this, new Object[] { e,
	...
	public static class row_talendStats_STATSStruct implements
		...
		final static byte[] commonByteArrayLock_CDI_NEW_PROD_generate_error = new byte[0];
		static byte[] commonByteArray_CDI_NEW_PROD_generate_error = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CDI_NEW_PROD_generate_error.length) {
					if (length < 1024
							&& commonByteArray_CDI_NEW_PROD_generate_error.length == 0) {
						commonByteArray_CDI_NEW_PROD_generate_error = new byte[1024];
					} else {
						commonByteArray_CDI_NEW_PROD_generate_error = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CDI_NEW_PROD_generate_error, 0,
						length);
				strReturn = new String(
						commonByteArray_CDI_NEW_PROD_generate_error, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CDI_NEW_PROD_generate_error) {
	...
	public static void main(String[] args) {
		final generate_error generate_errorClass = new generate_error();

		int exitCode = generate_errorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = generate_error.class
					.getClassLoader().getResourceAsStream(
							"cdi_new_prod/generate_error_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : generate_error");
		}
...
/************************************************************************************************
 * 40781 characters generated by Talend Open Studio for Data Integration on the
 * 12 февраля 2019 г. 19:18:38 KRAT
 ************************************************************************************************/
